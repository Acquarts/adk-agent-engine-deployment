...
STAGING_BUCKET = "gs://your-bucket"             # Your GCS bucket (gs://bucket-name)

AGENT_FOLDER = "your_agent_folder"              # Name of your agent folder
AGENT_DISPLAY_NAME = "My Agent"                 # Display name in UI
AGENT_DESCRIPTION = "Description of my agent"   # Agent description
